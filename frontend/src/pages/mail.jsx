      ...
      return (
        <div className="mt-2">
          <div className="w-100 mh-100"> 
            { !this.state.messages && <h2 className="d-block m-4">Mail</h2> }
            { this.state.messages && <h2 className="d-block m-4">{this.props.username} Mail</h2> }
            ...
            { this.state.messages && 
              this.state.messages.data.map((x, i) => <div className="border-dark card ml-5 mr-5 mt-3" key={ i }> 
                    ...
                    <div className="card-body border-dark p-2 bg-light"> <p>{x.content}</p> </div>
                </div>)
            }
            </div>
